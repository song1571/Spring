...
public class UserServiceTest {
	private static final int MIN_LOGCOUNT_FOR_SILVER = 0;
	private static final int MIN_RECCOMEND_FOR_GOLD = 0;
	...
	public void setUp() {	
		...
		users = Arrays.asList(
				new User("madnite1", "이상호", "p4", "songsh96kr@gmail.com", Level.SILVER, 60, MIN_RECCOMEND_FOR_GOLD),
				new User("bumjin", "박범진", "p1", "songsh96kr@gmail.com", Level.BASIC, MIN_LOGCOUNT_FOR_SILVER-1, 0),
				new User("joytouch", "강명성", "p2", "songsh96kr@gmail.com", Level.BASIC, MIN_LOGCOUNT_FOR_SILVER, 0),
				new User("erwins", "신승한", "p3", "songsh96kr@gmail.com", Level.SILVER, 60, MIN_RECCOMEND_FOR_GOLD-1),				
				new User("green", "오민규", "p5", "songsh96kr@gmail.com", Level.GOLD, 100, Integer.MAX_VALUE)
				);
	}
